...
class QLearner(object):
  ...
  def __init__(
    ...
    q_val_target = q_func(obs_t_float, self.num_actions, scope="q_func_val", reuse=False)
    self.total_error = q_val - (self.rew_t_ph + gamma * q_val_target)

    q_func_vars = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='q_func')
    target_q_func_vars = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='q_func_val')
